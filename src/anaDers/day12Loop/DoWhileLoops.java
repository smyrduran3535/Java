...
public class DoWhileLoops {
    public static void main(String[] args) {
        ...
        //herhangi bir karakterden kesmek icin Split kullanırız FAKAT burda kullanamayız
        // cunku Split Stringlerde kullanılır. o yuzden String sınıfına gidip valuOf methodunu alırız Stringe cevirmek icin
        ...
        int decimalInt = Integer.valueOf(decimalPart);//stringi tekrar int a donusturduk
