...
public enum UsStates {
    ...
    //enumların final seyler icerir setter kullanılmaz


    public static String getStateNameFromAbbreviation(String abbreviation){//neyi istiyorsan icine onu yazman lazim
//enumlarda lambda kullanmak istiyorsak;Arrays.stream(values() kullanılmalı
        ///lambda collectionlarda ve arraylerde kullanılır
        return Arrays.stream(values()).//ulkeleri alır
              filter(UsStates->UsStates.getAbbreviation().equals(abbreviation)).//verdigimiz kurala gore onları eler..ALABAMA.AL.equals FL aynı degil
                // bi sonrakine bakar..eleme isi FL ye kadar devam eder...sonra
                  findFirst().//sonra filter birden fazla option varsa ilkini verir bize:FLORIDA("Florida","FL","Tallahasse") yi verir
                get().//Optinal verir biz bunu Stringe ceviriyoruz;data tipini degistirir
                getStateName();
